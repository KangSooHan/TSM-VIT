...
class Hparams:
    ...
    parser.add_argument('--num_segments', type=int, default=3, help='number of segment')
    parser.add_argument('--num_frames', type=int, default=3, help='number of segment')
    parser.add_argument('--num_layers', type=int, default=3, help='number of segment')
